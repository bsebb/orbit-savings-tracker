  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex gap-3 mb-6 flex-wrap">
        ...
        <div className="flex items-center bg-white/70 dark:bg-gray-900/70 border border-gray-200 dark:border-gray-700 rounded-2xl px-3.5 py-3 focus-within:ring-2 focus-within:ring-indigo-400 w-28 sm:w-32">
          <span className="text-sm font-semibold text-gray-400 select-none mr-1.5 shrink-0">
            {sym.trim()}
          </span>
          <input
            type="number"
