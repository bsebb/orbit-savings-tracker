      ...
      <AnimatePresence>
        {open && (
          <motion.ul
            ...
            className="absolute z-50 mt-2 w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl overflow-hidden py-1"
          >
            {options.map((o) => (
              <li key={o.value}>
                <button
