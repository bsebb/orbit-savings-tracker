                    ...
                    {!isLoggingHere ? (
                      ...
                      >
                        <div className="flex gap-1.5">
                          <div className="relative flex-1">
                            ...
                            <input
                              ...
                              required
                              className="w-full bg-white dark:bg-gray-800 border border-indigo-400 rounded-xl pl-6 pr-2 py-1.5 text-xs text-gray-900 dark:text-gray-100 focus:outline-none"
                            />
                          </div>
                          ...
                          <input
                            ...
                            className="flex-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-2.5 py-1.5 text-xs text-gray-900 dark:text-gray-100 focus:outline-none"
                          />
                        </div>
                        ...
                        <div className="flex justify-end gap-1.5">
                          ...
                          <button
                            type="submit"
                            className="px-3 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-semibold shadow-sm"
                          >
                            Log
                          </button>
                        </div>
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                      <div className="relative flex-1 sm:w-32 sm:flex-none">
                        ...
                        <input
                          ...
                          className="w-full bg-white/70 dark:bg-gray-900/70 border border-gray-200 dark:border-gray-700 rounded-2xl pl-7 pr-3 py-2.5 text-xs text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400"
                        />
                      </div>
